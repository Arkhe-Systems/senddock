...
## Option 1: One-line installer (Ubuntu) — recommended
...
The script prompts for your public URL (e.g. `https://email.example.com`); everything else is autogenerated. Ubuntu 22.04+ only — for other distros use Option 2 below.
